...
import foto from "./Daco_4319404.png";
      ...
      >
        ...
        <Card style={{ width: "23rem", marginBottom: 20 }}>
          ...
          <Card.Body>
            ...
            <Card.Text>
              Shows the collection of movies, you can search them, check the
              plot, and filter by genre.
            </Card.Text>
            <Button variant="primary">Open</Button>
          </Card.Body>
        </Card>
        <Card style={{ width: "23rem", marginBottom: 20 }}>
          ...
          <Card.Body>
            ...
            <Card.Text>
              Shows a typical list to do where you can add elements, remove
              them, pin them to the top.
            </Card.Text>
            <Button variant="primary">Open</Button>
          </Card.Body>
        </Card>
